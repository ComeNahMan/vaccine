...
if(vaxCard.fullyVaccined == true) {
 ...
 function idCard(personName, expiration) {
	 ...
	 var person3 = new idCard('Jason James', '2020-12-25');
	 var person4 = new idCard('Nigel Arthur', '2024-05-09');
	 ...
	 var personVax3 = new vaxCard('Jason James', undefined, false);
	 var personVax4 = new vaxCard('Nigel Arthur', '2021-10-13', true);
